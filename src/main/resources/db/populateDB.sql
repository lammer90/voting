...
VALUES
       ...
       ('ролл с угрем', date_trunc('day', now()), 10000, 100006),
       ('суши с лососем', date_trunc('day', now()), 12000, 100006),
       ('острый суп', date_trunc('day', now()), 5000, 100006),

       ('бургер с говядиной', date_trunc('day', now()), 14000, 100007),
       ('салат из овощей', date_trunc('day', now()), 3000, 100007),
       ('суп грибной', date_trunc('day', now()), 10000, 100007),

       ('паста с беконом', date_trunc('day', now()), 12000, 100008),
       ('салат цезарь', date_trunc('day', now()), 12000, 100008),
       ('булочка белая', date_trunc('day', now()), 2000, 100008);
